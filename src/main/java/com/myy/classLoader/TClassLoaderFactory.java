...
public class TClassLoaderFactory {
    ...
    public static final String LOADER_NAME = "com.nestia.util.classloader.name";
    public static final String NETROOT_URL = "com.nestia.util.classloader.NetworkClassLoader";
    public static final String FILEROOT_PATH = "com.nestia.util.classloader.FileClassLoader";
